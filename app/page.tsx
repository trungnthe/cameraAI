...
export default function CameraAIWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white scroll-smooth">
      <section className="py-20 md:py-32 bg-gradient-to-b from-red-400 to-yellow-150 bg-no-repeat bg-cover bg-center">
            ...
            <div className="space-y-8  p-6 rounded-xl ">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-700 max-w-2xl">
                  Camera AI 4G/5G là một loại camera an ninh sử dụng kết nối
                  mạng di động 4G hoặc 5G để truyền tải dữ liệu, đồng thời tích
                  hợp trí tuệ nhân tạo (AI) để phân tích và xử lý hình ảnh/video
                  trực tiếp trên thiết bị (Edge AI) hoặc thông qua nền tảng đám
                  mây. Đây là sự kết hợp mạnh mẽ, mang lại khả năng giám sát
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Áp dụng AI và công nghệ tiên tiến cho các giải pháp giám sát toàn
              diện.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Yếu tố &quot;thông minh&quot; giúp camera không chỉ đơn thuần
                  ghi hình mà còn &quot;hiểu&quot; được những gì đang diễn ra.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Xác định và theo dõi cá nhân bằng công nghệ nhận dạng khuôn
                  mặt và phân tích hành vi có độ chính xác cao.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Hệ thống thông báo thông minh giúp giảm báo động giả và ưu
                  tiên các sự kiện quan trọng.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Sử dụng sim data 4G/5G giúp tăng khả năng xử lý và ổn định
                  đường truyền mạng.
                </p>
              </CardContent>
            </Card>
      ...
      <section id="demo" className="py-20 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              Trải nghiệm thực tế cameraAI
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Xem và trải nghiệm cameraAI để hiểu rõ hơn về cách công nghệ hoạt
              động.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Xem camera của chúng tôi theo thời gian thực
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-sm text-gray-600">
                  Kiểm tra khả năng phát hiện đối tượng, nhận dạng khuôn mặt và
                  theo dõi chuyển động bằng webcam hoặc video đã tải lên.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              ...
              <strong className="text-red-500">MCK Group</strong> hợp tác cùng
              các đối tác uy tín...
            </p>
          </div>
      ...
      <section
        id="services"
        className="py-20 md:py-32 bg-gradient-to-br from-gray-50 to-gray-100"
      >
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center space-y-4 mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Các gói dịch vụ theo tháng, năm với giá tiền cụ thể được chúng tôi
              cung cấp:
            </p>
          </div>
                  ...
                  <div className="space-y-4">
                    {plan.features.map((feature, featureIndex) => (
                      <div
                        ...
                        style={{
                          animationDelay: `${Number.parseInt(plan.delay) + featureIndex * 50}ms`,
                        }}
                      >
      ...
      <section id="contact" className="py-20 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Bạn đã sẵn sàng chuyển đổi hệ thống bảo mật của mình bằng AI chưa?
              Hãy liên hệ với chuyên gia của chúng tôi để được tư vấn riêng.
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      85 Nguyễn Ngọc Vũ, Trung Hòa, Cầu Giấy, Hà Nội
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl relative">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4 animate-fade-in-up">
              ...
              <p className="text-gray-400 leading-relaxed">
                Các giải pháp camera chạy bằng AI thế hệ tiếp theo cho nhu cầu
                giám sát và bảo mật hiện đại.
              </p>
              <div className="flex space-x-4">
          ...
          >
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} CameraAI. Đã đăng ký bản quyền.
            </p>
